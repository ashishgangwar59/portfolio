...
const projectsData: Record<string, any> = {
  "probeme-ai": {
    ...
    year: "2023 - 2024",
    description:
      "Professional chatbot integration for resume optimization and career development. Provides actionable, result-focused suggestions for technical skills and professional growth.",
    overview:
      "A sophisticated AI-powered platform designed to help professionals optimize their resumes and career trajectories. Probeme AI leverages advanced NLP and machine learning to provide personalized recommendations for technical skills enhancement and professional development.",
    keyFeatures: [
